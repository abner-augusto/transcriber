...
- **VRAM Safety**: Both engines chunk long audio internally, bounding peak VRAM below 6 GB (Qwen3 + ForcedAligner) and 7 GB (VibeVoice), well beneath the 14 GB system ceiling.
